		...
		switch (bangun){
			...
			case 3:
				...
				if(ruang==1){
					...
					cin>>t;
					cout<<"Prisma memiliki volume: "<<0.5*(alas*tinggis*t)<<endl;
					cout<<"Ulangi? (y/n)"<<endl;
					cin>>ulang;
					system("cls");
				}
					...
					cin>>t;
					cout<<"Limas memiliki luas: "<<0.3*0.5*alas*tinggis*t<<endl;
					cout<<"Ulangi? (y/n)"<<endl;
					cin>>ulang;
					system("cls");
				}
					...
					cout<<"Masukkan tinggi segitiga: ";
					cin>>tinggis;
					cout<<"Segitiga memiliki luas: "<<alas*tinggis/2<<" dan keliling "<<sqrt((alas*alas)+(tinggis*tinggis))+alas+tinggis<<endl;
					cout<<"Ulangi? (y/n)"<<endl;
					cin>>ulang;
					system("cls");
				}
